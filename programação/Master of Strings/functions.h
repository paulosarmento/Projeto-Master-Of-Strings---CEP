#ifndef _MASTER_OF_STRINGS_
#define _MASTER_OF_STRINGS_
...
static char *listaMusicas[NUM_MUSICAS] = 
{
	"musicas/parabens.mid",
	"musicas/masterofpuppets.mid",
	//"musicas/mrcrowley.mid",
	//"musicas/sweetchildomine.mid"
};

static char *listaPosicoes[NUM_MUSICAS] = 
{
	"musicas/parabens.txt",
	"musicas/masterofpuppets.txt",
	//"musicas/mrcrowley.txt",
	//"musicas/sweetchildomine.txt"
};

static wchar_t *listaNomes[NUM_MUSICAS] = 
{
	L"Parabens para voce",
	L"Master of Puppets",
	//L"Mr. Crowley",
